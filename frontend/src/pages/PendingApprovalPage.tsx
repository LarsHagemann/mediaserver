    ...
    <div className="min-h-screen bg-bg-base flex flex-col">
      ...
      <div className="bg-surface-2 rounded-t-2xl p-6 sm:rounded-xl sm:m-auto sm:w-full sm:max-w-sm">
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-xl font-bold text-text-primary">{t("pendingApproval.title")}</h1>
        </div>
        <p className="text-text-secondary text-sm mb-6">{t("pendingApproval.description")}</p>
